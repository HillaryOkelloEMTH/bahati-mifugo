...
public interface ProductConfigRepo extends JpaRepository<ProductConfig,Long> {
    ...
    @Query(value = "SELECT pc.product_name,pc.buying_price ,pc.selling_price ,pc.quantity ,pc.unit_measurement ,pc.effective_from ,r.route  from product_config pc join route r on r.id=pc .route_fk",nativeQuery = true)
