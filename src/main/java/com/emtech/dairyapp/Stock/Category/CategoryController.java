...
public class CategoryController {
    ...
    public Mono<ResponseEntity<StockEntitiesResponse>> activateCategory(@PathVariable Long categoryId){
        StockEntitiesResponse response = this.categoryService.updateCategoryStatus(categoryId, 1);
    ...
    public Mono<ResponseEntity<StockEntitiesResponse>> deactivateCategory(@PathVariable Long categoryId){
        StockEntitiesResponse response = this.categoryService.updateCategoryStatus(categoryId, 0);
